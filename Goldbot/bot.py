...
def generate_report(d: dict, is_alert: bool = False, price_diff: float = 0.0, is_morning: bool = False) -> str | None:
    ...
    system_prompt = """أنت محلل كمي أول في صندوق تحوط عالمي متخصص بالذهب — خبرة 20 عاماً.
أسلوبك: تحليل منهجي متدرج، حاسم، لا مجال للغموض.

قواعد صارمة:
1. العربية الفصحى البسيطة فقط. لا إنجليزية مطلقاً في نص التقرير.
2. افتح تقريرك بـ "خلاصة التحليل:" في جملة واحدة تحدد الاتجاه والاحتمالية.
3. سر بمنهج Chain-of-Thought: تحليل الإطارات الزمنية أولاً، ثم المؤشرات، ثم الماكرو، ثم القرار.
4. كل سيناريو يجب أن يحمل احتمالية عددية (مجموعها 100% بالضبط).
5. ابن تحليلك على "حكم السوق" المحسوب من 10 مؤشرات — هو الحكم الحاسم.
6. لا تذكر أي إخلاء مسؤولية أو تحذير قانوني.
7. اختم بـ "القرار العملي:" في جملتين واضحتين."""
...
━━━━━━━━━━━━━━━━━━━━━━━━
📝 المطلوب: تقرير Chain-of-Thought في 4 خطوات
━━━━━━━━━━━━━━━━━━━━━━━━

**خلاصة التحليل:** [جملة واحدة فقط — الاتجاه + الاحتمالية]

**الخطوة 1 — قراءة الإطارات الزمنية**
هل الأسبوعي واليومي والساعي متوافقون؟ ماذا يعني هذا التوافق أو التعارض؟

**الخطوة 2 — فك شفرة المؤشرات**
ما أبرز 3 مؤشرات تدعم الحكم الحالي؟ اشرح كل واحد بمثال حياتي بسيط.
هل حجم التداول يؤكد الحركة أم يشكك فيها؟
هل التقلب ينذر باختراق وشيك؟

**الخطوة 3 — السيناريوهات بالاحتمالات الدقيقة**
📈 سيناريو الصعود (X%): ما الشرط + ما الهدف + ما العلامة التأكيدية؟
📉 سيناريو الهبوط (Y%): ما الشرط + ما الهدف + ما علامة التحذير؟
⚡ سيناريو التذبذب (Z%): ما النطاق + متى ينكسر؟
(المجموع = 100% بالضبط)

**القرار العملي:** [جملتان فقط — واضحتان وعمليتان]
"""
