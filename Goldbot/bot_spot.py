...
اترك جميع الأرقام والنسب المئوية كما هي تماماً. التزم بالقالب تماماً ولا تكتب أي نصوص إضافية أو مقدمات."""
    ...
    _sum_txt   = f'حركة العوائد (2Y/{tnx:.2f}%’ 10Y/{tnx:.2f}% ’ 30Y/{tty_str}) ومنحنى {curve_state} يشيران إلى {_spread10}.'
    return template\
...
def _build_template_13(d: dict) -> str:
    ...
    # Accurate trend logic (Daily and Weekly) using core computation
...
[اربط بين الاتجاه اليومي والأسبوعي بدقة استناداً إلى حركة السعر الحقيقية والميل العام. حدد بوضوح أين تتمركز السيولة الآن وهل تدعم اختراق المقاومات أم كسر الدعوم. لا تستخدم عبارات عائمة، بل اعطِ قراءة فنية عميقة تربط الزمن بالسعر.]
...
المقارنة IV vs HV: [قارن بدقة بين التقلب المتوقع والتاريخي لمعرفة ما إذا كانت العقود رخيصة أم غالية (أعلى من قيمتها)، وماذا يعني ذلك للمشتري والبائع.]
💡 الحكم للتأثير النهائي على الذهب: [إيجابي/سلبي ولماذا]
...
[اشرح بناءً على أسعار الذهب والاتجاه ما إذا كان انحراف التقلب (Skew) يميل بقوة نحو الـ Calls أم الـ Puts. فسر أين يضع كبار المستثمرين أموالهم للتحوط الانفجاري الآن.]
💡 الحكم للتأثير النهائي على الذهب: [إيجابي/سلبي ولماذا]
...
def _build_spot_s9(d: dict) -> str:
    ...
    return (
        ...
        "#### 📆 3. التداول الأسبوعي والسوينج (مدى أبعد - إدارة رأس مال صارمة)\n"
        ...
        "### ⚠️ إدارة المخاطر (Risk Appetite Profile) ⚠️\n"
