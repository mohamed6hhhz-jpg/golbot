...
replacement = r"""def _build_spot_s1(d: dict) -> str:
...
# USE A LAMBDA to prevent re.sub from evaluating \n in the replacement string!!!
new_content = re.sub(regex, lambda m: replacement + "\ndef _build_spot_s4(d: dict) -> str:", text, flags=re.DOTALL)
