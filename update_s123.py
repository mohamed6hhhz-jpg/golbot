...
def update_templates(filename):
    ...
    new_s1 = '''def _build_spot_s1(d: dict) -> str:
    ...
    new_s2 = '''def _build_spot_s2(d: dict) -> str:
    """2/12 - الاطارات الزمنية"""
    nums = _s_nums(d)
    gold, atr, pivot = nums['gold'], nums['atr'], nums['pivot']
    rsi, macd = nums['rsi'], nums['macd']
    r1, r2, s1, s2 = nums['r1'], nums['r2'], nums['s1'], nums['s2']
    ...
    new_s3 = '''def _build_spot_s3(d: dict) -> str:
    ...
    return (
        ...
        f"📈 **أعلى قمة يومية (Swing H):** {sh:.2f}$\\n"
        "━━━━━━━━━━━━━━━━━━━━━━━━━━\\n"
